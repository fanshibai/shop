...
public class GoodsInfo {
    ...
    public GoodsInfo(Integer id, String goods_name, String goods_description, String goods_pic, Double goods_price, Double goods_price_off, Double goods_discount, Integer goods_stock, Integer goods_fatherid, Integer goods_parentid, Integer flag) {
        this.id = id;
    ...
    public GoodsInfo(String goods_name, String goods_description, String goods_pic, Double goods_price, Double goods_price_off, Double goods_discount, Integer goods_stock, Integer goods_fatherid, Integer goods_parentid) {
        this.goods_name = goods_name;
        this.goods_description = goods_description;
        this.goods_pic = goods_pic;
        this.goods_price = goods_price;
    ...
    public GoodsInfo(Integer id, String goods_name, String goods_description, String goods_pic, Double goods_price, Double goods_price_off, Double goods_discount, Integer goods_stock, Integer goods_fatherid, Integer goods_parentid) {
        this.id = id;
        this.goods_name = goods_name;
        this.goods_description = goods_description;
        this.goods_pic = goods_pic;
