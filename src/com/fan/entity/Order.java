...
public class Order {
    ...
    public Order(Integer id, String o_sendtype, String o_paytype, Double o_paycount, Integer userid, String o_shperson, String o_shphone, String o_shaddress) {
        this.id = id;
    ...
    public Order(String o_sendtype, String o_paytype, Double o_paycount, Integer userid, String o_shperson, String o_shphone, String o_shaddress) {
        this.o_sendtype = o_sendtype;
        this.o_paytype = o_paytype;
        this.o_paycount = o_paycount;
        this.userid = userid;
