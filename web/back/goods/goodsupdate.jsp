...
<script type="text/javascript" src="js/jquery-1.8.2.js"></script>
	<script type="text/javascript">
		$(function () {
			//1.从后台获取对应的大类别和小类别的数据
			var parent_id = ${goodsInfo.goods_parentid};
			var father_id = ${goodsInfo.goods_fatherid};
			...
			//3.初始化大类别
			initGoodsType(0,goods_parentid,parent_id);

			//4.初始化小类别
			initGoodsType(parent_id,goods_fatherid,father_id);
			...
			goods_parentid.change(function () {
				...
				//3.初始化小类别
				initGoodsType(newParentId,goods_fatherid,father_id);
			})
...
<body>
    ...
    <form method="post" action="GoodsInfoServlet?action=updateGoodsInfo" enctype="multipart/form-data">
	    ...
	    <li><label>商品价格</label><input name="goods_price" type="text" class="dfinput" value="${goodsInfo.goods_price}"/></li>
	    <li><label>商品图片</label><input name="goods_pic" type="file" id="uploadFile"/></li>
			<img  id="goods_pic_ele" src="images/${goodsInfo.goods_pic}" alt="加载失败">
	    <li><label>商品描述</label><textarea rows="8" cols="40" name="goods_description"  >${goodsInfo.goods_description}</textarea></li>
